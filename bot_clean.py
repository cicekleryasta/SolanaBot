...
VIP_WALLETS = {
    ...
    "EvGpkcSBfhp5K9SNP48wVtfNXdKYRBiK3kvMkB66kU3Q": "EARLY",
}
    ...
    try:
        ...
        if address in VIP_WALLETS and market_cap >= 10000 and usd_amount >= 10:
            ...
            msg = (f"{star}🚨 VIP ALIM\n"
                   ...
                   f"💸 ${usd_amount:,.0f}\n"
                   f"📍 {memecoin_mint}\n"
                   f"https://dexscreener.com/solana/{memecoin_mint}")
            send_telegram(msg)

        # WATCH ALARM - min $50, min 50k MC, 3 wallets = CONVOY
