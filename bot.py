...
WATCH_WALLETS = {
    ...
    # Yeni 67 (çakışanlar kaldırılmış)
...
vip_seen_coins = {}     # VIP cüzdan için ilk kez görülen coinler {address: set()}
coin_buyers = {}        # mint -> {address: dolar_miktarı}
convoy_alerted = set()  # Konvoy alarmı gönderilen mintler — tekrar gitmesin
